									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission_addPermission.do?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
												<a href="${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission_deletePermission.do?id=${role.id}" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
